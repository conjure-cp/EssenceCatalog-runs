...
# too much memory, partial runs
# csplib-prob006-GolombRulerDecision
# csplib-prob013-ProgPartyFunction
# csplib-prob017-RamseyNumbers
# csplib-prob018-WaterBuckets
# csplib-prob024-LangfordCombinedDirect
# csplib-prob024-LangfordCombinedPositional
# csplib-prob024-LangfordDirect
# csplib-prob024-LangfordPositional
# csplib-prob028-BIBD
# csplib-prob030-BACP
# csplib-prob032-MaximumDensityStillLife 
# csplib-prob033-WordDesign
# csplib-prob031-RackConfiguration
# csplib-prob034-WarehouseLocation

# not yet
# csplib-prob038-SteelMill csplib-prob039-Rehearsal csplib-prob040-DistributionWagnerWhitin csplib-prob041-NFractionsPuzzle csplib-prob044-Steiner csplib-prob045-CoveringArray csplib-prob048-MinimumEnergyBroadcast csplib-prob049-NumberPartitioningFull csplib-prob049-NumberPartitioningSimple csplib-prob050-DiamondFree csplib-prob051-TankAllocation csplib-prob053-GracefulDoubleWheelGraphs csplib-prob053-GracefulGears csplib-prob053-GracefulHelms csplib-prob053-GracefulWheelGraphs csplib-prob054-NQueens csplib-prob055-EFPA csplib-prob056-SONET csplib-prob065-OPD csplib-prob083-Transshipment csplib-prob086-CVRP csplib-prob110-ArmiesOfQueens csplib-prob115-TailAssignment csplib-prob116-Vellino csplib-prob132-Layout csplib-prob133-Knapsack

pushd EssenceCatalog/problems > /dev/null               # go through all problems in EssenceCatalog
for prob in csplib-* ; do
# for prob in csplib-prob001-CarSequencing csplib-prob002-TemplateDesign csplib-prob003-QG3 csplib-prob003-QG4 csplib-prob003-QG5 csplib-prob003-QG6 csplib-prob003-QG7 csplib-prob005-LABS csplib-prob006-GolombRuler csplib-prob007-AllIntervalSeries csplib-prob008-VesselLoading csplib-prob009-PerfectSquarePlacement csplib-prob010-SocialGolfers csplib-prob013-ProgPartyFunctionDecision csplib-prob013-ProgPartyPartition csplib-prob015-SchursLemma csplib-prob016-TrafficLights csplib-prob019-MagicSquares csplib-prob021-Crossfigures csplib-prob022-BusDriverScheduling csplib-prob023-AbnormalMagicHexagons csplib-prob023-MagicHexagon csplib-prob025-Lam csplib-prob026-SportsTournamentScheduling csplib-prob036-FLECC ; do
